...
{ "ER_TABLEACCESS_DENIED_ERROR", 1142, "%-.32s command denied to user \'%s\'@\'%s\' for table \'%-.192s\'" },
...
{ "ER_TRUNCATED_WRONG_VALUE_FOR_FIELD", 1366, "Incorrect %-.32s value: \'%-.128s\' for column \'%.192s\' at row %lu" },
...
{ "ER_COL_COUNT_DOESNT_MATCH_PLEASE_UPDATE", 1558, "Column count of mysql.%s is wrong. Expected %d, found %d. Created with MariaDB %d, now running %d. Please use mysql_upgrade to fix this error." },
...
{ "ER_UNUSED_1", 1726, "You should never see it" },
...
{ "ER_VCOL_BASED_ON_VCOL", 1900, "A computed column cannot be based on a computed column" },
{ "ER_VIRTUAL_COLUMN_FUNCTION_IS_NOT_ALLOWED", 1901, "Function or expression is not allowed for column \'%s\'" },
{ "ER_DATA_CONVERSION_ERROR_FOR_VIRTUAL_COLUMN", 1902, "Generated value for computed column \'%s\' cannot be converted to type \'%s\'" },
{ "ER_PRIMARY_KEY_BASED_ON_VIRTUAL_COLUMN", 1903, "Primary key cannot be defined upon a computed column" },
{ "ER_KEY_BASED_ON_GENERATED_VIRTUAL_COLUMN", 1904, "Key/Index cannot be defined on a non-stored computed column" },
{ "ER_WRONG_FK_OPTION_FOR_VIRTUAL_COLUMN", 1905, "Cannot define foreign key with %s clause on a computed column" },
{ "ER_WARNING_NON_DEFAULT_VALUE_FOR_VIRTUAL_COLUMN", 1906, "The value specified for computed column \'%s\' in table \'%s\' has been ignored" },
{ "ER_UNSUPPORTED_ACTION_ON_VIRTUAL_COLUMN", 1907, "This is not yet supported for computed columns" },
{ "ER_CONST_EXPR_IN_VCOL", 1908, "Constant expression in computed column function is not allowed" },
{ "ER_ROW_EXPR_FOR_VCOL", 1909, "Expression for computed column cannot return a row" },
{ "ER_UNSUPPORTED_ENGINE_FOR_VIRTUAL_COLUMNS", 1910, "%s storage engine does not support computed columns" },
{ "ER_UNKNOWN_OPTION", 1911, "Unknown option \'%-.64s\'" },
{ "ER_BAD_OPTION_VALUE", 1912, "Incorrect value \'%-.64s\' for option \'%-.64s\'" },
