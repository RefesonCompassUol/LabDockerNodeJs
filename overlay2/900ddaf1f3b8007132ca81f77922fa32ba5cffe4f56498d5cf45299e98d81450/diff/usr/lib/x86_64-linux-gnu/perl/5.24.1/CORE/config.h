 ...
 */
#define ARCHLIB "/usr/lib/x86_64-linux-gnu/perl/5.24"		/**/
#define ARCHLIB_EXP "/usr/lib/x86_64-linux-gnu/perl/5.24"		/**/
 ...
 *	in programs that are not prepared to deal with ~ expansion at run-time.
 */
#define SITEARCH "/usr/local/lib/x86_64-linux-gnu/perl/5.24.1"		/**/
#define SITEARCH_EXP "/usr/local/lib/x86_64-linux-gnu/perl/5.24.1"		/**/
 ...
 *	in programs that are not prepared to deal with ~ expansion at run-time.
 */
#define PERL_VENDORARCH "/usr/lib/x86_64-linux-gnu/perl5/5.24"		/**/
#define PERL_VENDORARCH_EXP "/usr/lib/x86_64-linux-gnu/perl5/5.24"		/**/
