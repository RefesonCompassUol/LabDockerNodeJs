...
def parse_qsl(qs, keep_blank_values=0, strict_parsing=0, separator='&'):
    """Parse a query given as a string argument."""
    warn("cgi.parse_qsl is deprecated, use urlparse.parse_qsl instead",
         PendingDeprecationWarning, 2)
    return urlparse.parse_qsl(qs, keep_blank_values, strict_parsing, separator=separator)
...
class FieldStorage:
    ...
    def __init__(self, fp=None, headers=None, outerboundary="",
                 environ=os.environ, keep_blank_values=0, strict_parsing=0, separator='&'):
    ...
    def read_urlencoded(self):
        ...
        for key, value in urlparse.parse_qsl(qs, self.keep_blank_values,
                                            self.strict_parsing, separator=self.separator):
    ...
    def read_multi(self, environ, keep_blank_values, strict_parsing):
        ...
        if self.qs_on_post:
            for key, value in urlparse.parse_qsl(self.qs_on_post,
                                self.keep_blank_values, self.strict_parsing, separator=self.separator):
